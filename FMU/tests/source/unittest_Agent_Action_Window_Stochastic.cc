...
class Test_Agent_Action_Window_Stochastic : public ::testing::Test {
 protected:
...
void Test_Agent_Action_Window_Stochastic::SetUp() {
...
TEST_F(Test_Agent_Action_Window_Stochastic, Arrival) {
  Utility::setSeed(1);
