...
class Test_Agent_Action_Shades_BDI : public ::testing::Test {
 protected:
    Agent_Action_Shades_BDI aas;
    std::vector<double> activities;
    virtual void SetUp();
};

void Test_Agent_Action_Shades_BDI::SetUp() {
...
TEST_F(Test_Agent_Action_Shades_BDI, ClosedDuringSleep) {
  ZoneStruct zs;
...
TEST_F(Test_Agent_Action_Shades_BDI, ClosedDuringWashing) {
  ZoneStruct zs;
  zs.name = "Block1:Kitchen";
  zs.id = 1;
  Building_Zone z_Kitchen;
