...
void Test_DataStore::SetUp() {
  DataStore::clear();
  Configuration::outputRegexs.clear();
}
...
TEST_F(Test_DataStore, regex) {
  //Configuration::outputRegexs.push_back("[a-zA-Z0-9\_]+");
  Configuration::outputRegexs.push_back(".*");
  ...
  DataStore::clear();
  Configuration::outputRegexs.clear();
  Configuration::outputRegexs.push_back("helloWorld");
  res = DataStore::addVariable("helloWorld");
  EXPECT_EQ(res, 0);
  res = DataStore::addVariable("hello1World");
  EXPECT_EQ(res, -1);
...
TEST_F(Test_DataStore, regex2) {
  ...
  Configuration::outputRegexs.push_back(".*elloWorld.*");
  res = DataStore::addVariable("helloWorld");
  EXPECT_EQ(res, 0);
  res = DataStore::addVariable("hello1World");
  EXPECT_EQ(res, -1);
...
TEST_F(Test_DataStore, regex3) {
  ...
  Configuration::outputRegexs.push_back(".*ello.*World.*");
  res = DataStore::addVariable("helloWorld");
  EXPECT_EQ(res, 0);
  res = DataStore::addVariable("hello1World");
  EXPECT_EQ(res, 1);
