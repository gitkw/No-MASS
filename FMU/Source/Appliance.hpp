...
struct ApplianceParameters {
  double power = 0.0; /*!< The power requested */
  double supply = 0.0; /*!< The power supplied */
  double suppliedLeft = 0.0; /*!< The power supplied after consumed by other appliances */
  double supplyCost = 0.0; /*!< The cost of the supplied power */
  double received = 0.0; /*!< The power received */
  double receivedCost = 0.0; /*!< The cost of power received */
};
